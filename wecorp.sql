...
INSERT INTO `business` VALUES (1,'Dhardware','Hardware','Brgy.SanFermin'),(2,'FM MAWL BANK','Bank','Brgy.SanFermin'),(3,'CAFE BREW AND BEERS','Cafe','Gov. F.N. Dy Blvd, Luna, Isabela'),(4,'AB Normal School','School','Brgy.District 2, Cauayan City, Isabela');
...
--
-- Table structure for table `electric_disconnections`
--

DROP TABLE IF EXISTS `electric_disconnections`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `electric_disconnections` (
  `electric_disconnection_id` int NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`electric_disconnection_id`),
  KEY `bill_id` (`bill_id`),
  CONSTRAINT `electric_disconnections_ibfk_1` FOREIGN KEY (`bill_id`) REFERENCES `electric_bills` (`bill_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `electric_disconnections`
--

LOCK TABLES `electric_disconnections` WRITE;
/*!40000 ALTER TABLE `electric_disconnections` DISABLE KEYS */;
/*!40000 ALTER TABLE `electric_disconnections` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `electric_meters` VALUES (1,1,'WM-new-001','kWh'),(2,2,'WM-new-002','kWh'),(3,3,'WM-new-003','kWh'),(4,4,'WM-new-004','kWh');
...
INSERT INTO `electric_rates` VALUES (1,8.50,0.00,2026);
...
INSERT INTO `electric_tax` VALUES (1,1,0.12),(2,3,0.02),(3,4,0.02),(4,5,0.01);
...
INSERT INTO `employees` VALUES ('24-16129','John Carlo Mina','Technician','jcnmina@gmail.com'),('24-16159','Kenneth Tejero','Cashier','kenntejero@gmail.com'),('24-16224','Immanuel Nunez','Meter Reader','immanuelnunez20@gmail.com'),('24-16249','Alexis Rivera','Administrator','alexistalosigrivera@gmail.com'),('24-16273','Alexis Valdez','Billing Officer','av505154@gmail.com');
...
INSERT INTO `tax` VALUES (1,'12% VAT','Standard Value Added Tax for ISELCO II electricity','Active'),(2,'2% Franchise Tax','Standard Franchise Tax for CCWD water services','Active'),(3,'Local Franchise Tax','City/Provincial local franchise tax','Active'),(4,'Universal Charge','Govt mandated charge for missionary & environmental','Active'),(5,'FIT-All','Feed-in-Tariff Allowance for renewable energy','Active');
...
--
-- Table structure for table `water_disconnections`
--

DROP TABLE IF EXISTS `water_disconnections`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `water_disconnections` (
  `water_disconnection_id` int NOT NULL AUTO_INCREMENT,
  `bill_id` int NOT NULL,
  `disconnection_date` date DEFAULT NULL,
  `reason` varchar(150) DEFAULT NULL,
  `status` enum('Disconnected','Reconnected') DEFAULT 'Disconnected',
  `reconnection_date` date DEFAULT NULL,
  `reconnection_fee` decimal(10,2) DEFAULT NULL,
  PRIMARY KEY (`water_disconnection_id`),
  KEY `bill_id` (`bill_id`),
  CONSTRAINT `water_disconnections_ibfk_1` FOREIGN KEY (`bill_id`) REFERENCES `water_bills` (`bill_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `water_disconnections`
--

LOCK TABLES `water_disconnections` WRITE;
/*!40000 ALTER TABLE `water_disconnections` DISABLE KEYS */;
/*!40000 ALTER TABLE `water_disconnections` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `water_meters` VALUES (1,1,'WM-new-001','m3'),(2,2,'WM-new-002','m3'),(3,3,'WM-new-003','m3'),(4,4,'WM-new-004','m3');
...
INSERT INTO `water_rates` VALUES (1,20.75,10.00,2026);
...
CREATE TABLE `water_readings` (
  ...
  KEY `fk_water_encoded` (`encoded_by`),
  CONSTRAINT `fk_water_encoded` FOREIGN KEY (`encoded_by`) REFERENCES `employees` (`employees_id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `water_tax` VALUES (1,2,0.02);
...
-- Dump completed on 2026-03-14 22:42:21
